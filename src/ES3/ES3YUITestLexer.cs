...
public partial class ES3YUITestLexer : Antlr.Runtime.Lexer
{
	...
	private void mABSTRACT()
	{
		...
		try
		{
			...
			// ES3YUITest.g:109:10: ( 'abstract' )
			DebugEnterAlt(1);
			// ES3YUITest.g:109:12: 'abstract'
			{
	...
	private void mBOOLEAN()
	{
		...
		try
		{
			int _type = BOOLEAN;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:115:9: ( 'boolean' )
			DebugEnterAlt(1);
			// ES3YUITest.g:115:11: 'boolean'
			{
	...
	private void mBREAK()
	{
		...
		try
		{
			int _type = BREAK;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:116:7: ( 'break' )
			DebugEnterAlt(1);
			// ES3YUITest.g:116:9: 'break'
			{
			DebugLocation(116, 9);
			Match("break"); 
	...
	private void mBYTE()
	{
		...
		try
		{
			int _type = BYTE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:117:6: ( 'byte' )
			DebugEnterAlt(1);
			// ES3YUITest.g:117:8: 'byte'
			{
			DebugLocation(117, 8);
			Match("byte"); 
	...
	private void mCASE()
	{
		...
		try
		{
			int _type = CASE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:118:6: ( 'case' )
			DebugEnterAlt(1);
			// ES3YUITest.g:118:8: 'case'
			{
			DebugLocation(118, 8);
			Match("case"); 
	...
	private void mCATCH()
	{
		...
		try
		{
			int _type = CATCH;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:119:7: ( 'catch' )
			DebugEnterAlt(1);
			// ES3YUITest.g:119:9: 'catch'
			{
			DebugLocation(119, 9);
			Match("catch"); 
	...
	private void mCHAR()
	{
		...
		try
		{
			int _type = CHAR;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:120:6: ( 'char' )
			DebugEnterAlt(1);
			// ES3YUITest.g:120:8: 'char'
			{
			DebugLocation(120, 8);
			Match("char"); 
	...
	private void mCLASS()
	{
		...
		try
		{
			int _type = CLASS;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:121:7: ( 'class' )
			DebugEnterAlt(1);
			// ES3YUITest.g:121:9: 'class'
			{
			DebugLocation(121, 9);
			Match("class"); 
	...
	private void mCONST()
	{
		...
		try
		{
			int _type = CONST;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:124:7: ( 'const' )
			DebugEnterAlt(1);
			// ES3YUITest.g:124:9: 'const'
			{
			DebugLocation(124, 9);
			Match("const"); 
	...
	private void mCONTINUE()
	{
		...
		try
		{
			int _type = CONTINUE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:125:10: ( 'continue' )
			DebugEnterAlt(1);
			// ES3YUITest.g:125:12: 'continue'
			{
	...
	private void mDEBUGGER()
	{
		...
		try
		{
			int _type = DEBUGGER;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:126:10: ( 'debugger' )
			DebugEnterAlt(1);
			// ES3YUITest.g:126:12: 'debugger'
			{
	...
	private void mDEFAULT()
	{
		...
		try
		{
			int _type = DEFAULT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:128:9: ( 'default' )
			DebugEnterAlt(1);
			// ES3YUITest.g:128:11: 'default'
			{
	...
	private void mDELETE()
	{
		...
		try
		{
			int _type = DELETE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:129:8: ( 'delete' )
			DebugEnterAlt(1);
			// ES3YUITest.g:129:10: 'delete'
			{
	...
	private void mDO()
	{
		...
		try
		{
			int _type = DO;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:132:4: ( 'do' )
			DebugEnterAlt(1);
			// ES3YUITest.g:132:6: 'do'
			{
			DebugLocation(132, 6);
			Match("do"); 
	...
	private void mDOUBLE()
	{
		...
		try
		{
			int _type = DOUBLE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:134:8: ( 'double' )
			DebugEnterAlt(1);
			// ES3YUITest.g:134:10: 'double'
			{
	...
	private void mELSE()
	{
		...
		try
		{
			int _type = ELSE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:135:6: ( 'else' )
			DebugEnterAlt(1);
			// ES3YUITest.g:135:8: 'else'
			{
			DebugLocation(135, 8);
			Match("else"); 
	...
	private void mENUM()
	{
		...
		try
		{
			int _type = ENUM;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:136:6: ( 'enum' )
			DebugEnterAlt(1);
			// ES3YUITest.g:136:8: 'enum'
			{
			DebugLocation(136, 8);
			Match("enum"); 
	...
	private void mEXPORT()
	{
		...
		try
		{
			int _type = EXPORT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:138:8: ( 'export' )
			DebugEnterAlt(1);
			// ES3YUITest.g:138:10: 'export'
			{
	...
	private void mEXTENDS()
	{
		...
		try
		{
			int _type = EXTENDS;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:139:9: ( 'extends' )
			DebugEnterAlt(1);
			// ES3YUITest.g:139:11: 'extends'
			{
	...
	private void mFALSE()
	{
		...
		try
		{
			int _type = FALSE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:140:7: ( 'false' )
			DebugEnterAlt(1);
			// ES3YUITest.g:140:9: 'false'
			{
			DebugLocation(140, 9);
			Match("false"); 
	...
	private void mFINAL()
	{
		...
		try
		{
			int _type = FINAL;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:141:7: ( 'final' )
			DebugEnterAlt(1);
			// ES3YUITest.g:141:9: 'final'
			{
			DebugLocation(141, 9);
			Match("final"); 
	...
	private void mFINALLY()
	{
		...
		try
		{
			int _type = FINALLY;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:142:9: ( 'finally' )
			DebugEnterAlt(1);
			// ES3YUITest.g:142:11: 'finally'
			{
	...
	private void mFLOAT()
	{
		...
		try
		{
			int _type = FLOAT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:143:7: ( 'float' )
			DebugEnterAlt(1);
			// ES3YUITest.g:143:9: 'float'
			{
			DebugLocation(143, 9);
			Match("float"); 
	...
	private void mFOR()
	{
		...
		try
		{
			int _type = FOR;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:144:5: ( 'for' )
			DebugEnterAlt(1);
			// ES3YUITest.g:144:7: 'for'
			{
			DebugLocation(144, 7);
			Match("for"); 
	...
	private void mFUNCTION()
	{
		...
		try
		{
			int _type = FUNCTION;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:145:10: ( 'function' )
			DebugEnterAlt(1);
			// ES3YUITest.g:145:12: 'function'
			{
	...
	private void mGOTO()
	{
		...
		try
		{
			int _type = GOTO;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:146:6: ( 'goto' )
			DebugEnterAlt(1);
			// ES3YUITest.g:146:8: 'goto'
			{
			DebugLocation(146, 8);
			Match("goto"); 
	...
	private void mIF()
	{
		...
		try
		{
			int _type = IF;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:149:4: ( 'if' )
			DebugEnterAlt(1);
			// ES3YUITest.g:149:6: 'if'
			{
			DebugLocation(149, 6);
			Match("if"); 
	...
	private void mIMPLEMENTS()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:150:12: ( 'implements' )
			DebugEnterAlt(1);
			// ES3YUITest.g:150:14: 'implements'
			{
	...
	private void mIMPORT()
	{
		...
		try
		{
			int _type = IMPORT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:151:8: ( 'import' )
			DebugEnterAlt(1);
			// ES3YUITest.g:151:10: 'import'
			{
	...
	private void mIN()
	{
		...
		try
		{
			int _type = IN;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:152:4: ( 'in' )
			DebugEnterAlt(1);
			// ES3YUITest.g:152:6: 'in'
			{
			DebugLocation(152, 6);
			Match("in"); 
	...
	private void mINSTANCEOF()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:154:12: ( 'instanceof' )
			DebugEnterAlt(1);
			// ES3YUITest.g:154:14: 'instanceof'
			{
	...
	private void mINT()
	{
		...
		try
		{
			int _type = INT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:155:5: ( 'int' )
			DebugEnterAlt(1);
			// ES3YUITest.g:155:7: 'int'
			{
			DebugLocation(155, 7);
			Match("int"); 
	...
	private void mINTERFACE()
	{
		...
		try
		{
			int _type = INTERFACE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:156:11: ( 'interface' )
			DebugEnterAlt(1);
			// ES3YUITest.g:156:13: 'interface'
			{
	...
	private void mLONG()
	{
		...
		try
		{
			int _type = LONG;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:161:6: ( 'long' )
			DebugEnterAlt(1);
			// ES3YUITest.g:161:8: 'long'
			{
			DebugLocation(161, 8);
			Match("long"); 
	...
	private void mNATIVE()
	{
		...
		try
		{
			int _type = NATIVE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:170:8: ( 'native' )
			DebugEnterAlt(1);
			// ES3YUITest.g:170:10: 'native'
			{
	...
	private void mNEW()
	{
		...
		try
		{
			int _type = NEW;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:172:5: ( 'new' )
			DebugEnterAlt(1);
			// ES3YUITest.g:172:7: 'new'
			{
			DebugLocation(172, 7);
			Match("new"); 
	...
	private void mNULL()
	{
		...
		try
		{
			int _type = NULL;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:175:6: ( 'null' )
			DebugEnterAlt(1);
			// ES3YUITest.g:175:8: 'null'
			{
			DebugLocation(175, 8);
			Match("null"); 
	...
	private void mPACKAGE()
	{
		...
		try
		{
			int _type = PACKAGE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:178:9: ( 'package' )
			DebugEnterAlt(1);
			// ES3YUITest.g:178:11: 'package'
			{
	...
	private void mPRIVATE()
	{
		...
		try
		{
			int _type = PRIVATE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:179:9: ( 'private' )
			DebugEnterAlt(1);
			// ES3YUITest.g:179:11: 'private'
			{
	...
	private void mPROTECTED()
	{
		...
		try
		{
			int _type = PROTECTED;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:180:11: ( 'protected' )
			DebugEnterAlt(1);
			// ES3YUITest.g:180:13: 'protected'
			{
	...
	private void mPUBLIC()
	{
		...
		try
		{
			int _type = PUBLIC;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:181:8: ( 'public' )
			DebugEnterAlt(1);
			// ES3YUITest.g:181:10: 'public'
			{
	...
	private void mRETURN()
	{
		...
		try
		{
			int _type = RETURN;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:185:8: ( 'return' )
			DebugEnterAlt(1);
			// ES3YUITest.g:185:10: 'return'
			{
	...
	private void mSHORT()
	{
		...
		try
		{
			int _type = SHORT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:191:7: ( 'short' )
			DebugEnterAlt(1);
			// ES3YUITest.g:191:9: 'short'
			{
			DebugLocation(191, 9);
			Match("short"); 
	...
	private void mSTATIC()
	{
		...
		try
		{
			int _type = STATIC;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:196:8: ( 'static' )
			DebugEnterAlt(1);
			// ES3YUITest.g:196:10: 'static'
			{
	...
	private void mSUPER()
	{
		...
		try
		{
			int _type = SUPER;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:199:7: ( 'super' )
			DebugEnterAlt(1);
			// ES3YUITest.g:199:9: 'super'
			{
			DebugLocation(199, 9);
			Match("super"); 
	...
	private void mSWITCH()
	{
		...
		try
		{
			int _type = SWITCH;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:200:8: ( 'switch' )
			DebugEnterAlt(1);
			// ES3YUITest.g:200:10: 'switch'
			{
	...
	private void mSYNCHRONIZED()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:201:14: ( 'synchronized' )
			DebugEnterAlt(1);
			// ES3YUITest.g:201:16: 'synchronized'
			{
	...
	private void mTHIS()
	{
		...
		try
		{
			int _type = THIS;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:202:6: ( 'this' )
			DebugEnterAlt(1);
			// ES3YUITest.g:202:8: 'this'
			{
			DebugLocation(202, 8);
			Match("this"); 
	...
	private void mTHROW()
	{
		...
		try
		{
			int _type = THROW;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:203:7: ( 'throw' )
			DebugEnterAlt(1);
			// ES3YUITest.g:203:9: 'throw'
			{
			DebugLocation(203, 9);
			Match("throw"); 
	...
	private void mTHROWS()
	{
		...
		try
		{
			int _type = THROWS;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:204:8: ( 'throws' )
			DebugEnterAlt(1);
			// ES3YUITest.g:204:10: 'throws'
			{
	...
	private void mTRANSIENT()
	{
		...
		try
		{
			int _type = TRANSIENT;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:205:11: ( 'transient' )
			DebugEnterAlt(1);
			// ES3YUITest.g:205:13: 'transient'
			{
	...
	private void mTRUE()
	{
		...
		try
		{
			int _type = TRUE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:206:6: ( 'true' )
			DebugEnterAlt(1);
			// ES3YUITest.g:206:8: 'true'
			{
			DebugLocation(206, 8);
			Match("true"); 
	...
	private void mTRY()
	{
		...
		try
		{
			int _type = TRY;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:207:5: ( 'try' )
			DebugEnterAlt(1);
			// ES3YUITest.g:207:7: 'try'
			{
			DebugLocation(207, 7);
			Match("try"); 
	...
	private void mTYPEOF()
	{
		...
		try
		{
			int _type = TYPEOF;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:208:8: ( 'typeof' )
			DebugEnterAlt(1);
			// ES3YUITest.g:208:10: 'typeof'
			{
	...
	private void mVAR()
	{
		...
		try
		{
			int _type = VAR;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:209:5: ( 'var' )
			DebugEnterAlt(1);
			// ES3YUITest.g:209:7: 'var'
			{
			DebugLocation(209, 7);
			Match("var"); 
	...
	private void mVOID()
	{
		...
		try
		{
			int _type = VOID;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:210:6: ( 'void' )
			DebugEnterAlt(1);
			// ES3YUITest.g:210:8: 'void'
			{
			DebugLocation(210, 8);
			Match("void"); 
	...
	private void mVOLATILE()
	{
		...
		try
		{
			int _type = VOLATILE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:211:10: ( 'volatile' )
			DebugEnterAlt(1);
			// ES3YUITest.g:211:12: 'volatile'
			{
	...
	private void mWHILE()
	{
		...
		try
		{
			int _type = WHILE;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:212:7: ( 'while' )
			DebugEnterAlt(1);
			// ES3YUITest.g:212:9: 'while'
			{
			DebugLocation(212, 9);
			Match("while"); 
	...
	private void mWITH()
	{
		...
		try
		{
			int _type = WITH;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:213:6: ( 'with' )
			DebugEnterAlt(1);
			// ES3YUITest.g:213:8: 'with'
			{
			DebugLocation(213, 8);
			Match("with"); 
	...
	private void mWhiteSpace()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:555:2: ( ( TAB | VT | FF | SP | NBSP | USP )+ )
			DebugEnterAlt(1);
			// ES3YUITest.g:555:4: ( TAB | VT | FF | SP | NBSP | USP )+
			{
			DebugLocation(555, 4);
			// ES3YUITest.g:555:4: ( TAB | VT | FF | SP | NBSP | USP )+
			int cnt1=0;
	...
	private void mCR()
	{
		...
		try
		{
			// ES3YUITest.g:567:2: ( '\\r' )
			DebugEnterAlt(1);
			// ES3YUITest.g:567:4: '\\r'
			{
			DebugLocation(567, 4);
			Match('\r'); 
	...
	private void mLineTerminator()
	{
		...
		try
		{
			// ES3YUITest.g:579:2: ( CR | LF | LS | PS )
			DebugEnterAlt(1);
			// ES3YUITest.g:
			{
			DebugLocation(579, 2);
	...
	private void mEOL()
	{
		...
		try
		{
			int _type = EOL;
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:583:2: ( ( ( CR ( LF )? ) | LF | LS | PS ) )
			DebugEnterAlt(1);
			// ES3YUITest.g:583:4: ( ( CR ( LF )? ) | LF | LS | PS )
			{
			DebugLocation(583, 4);
			// ES3YUITest.g:583:4: ( ( CR ( LF )? ) | LF | LS | PS )
			int alt3=4;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:583:6: ( CR ( LF )? )
				{
				DebugLocation(583, 6);
				// ES3YUITest.g:583:6: ( CR ( LF )? )
				DebugEnterAlt(1);
				// ES3YUITest.g:583:8: CR ( LF )?
				{
				DebugLocation(583, 8);
				mCR(); 
				DebugLocation(583, 11);
				// ES3YUITest.g:583:11: ( LF )?
				int alt2=2;
	...
	private void mMultiLineComment()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:590:2: ( '/*' ( options {greedy=false; } : . )* '*/' )
			DebugEnterAlt(1);
			// ES3YUITest.g:590:4: '/*' ( options {greedy=false; } : . )* '*/'
			{
			DebugLocation(590, 4);
			Match("/*"); 

			DebugLocation(590, 9);
			// ES3YUITest.g:590:9: ( options {greedy=false; } : . )*
	...
	private void mSingleLineComment()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:594:2: ( '//' (~ ( LineTerminator ) )* )
			DebugEnterAlt(1);
			// ES3YUITest.g:594:4: '//' (~ ( LineTerminator ) )*
			{
			DebugLocation(594, 4);
			Match("//"); 

			DebugLocation(594, 9);
			// ES3YUITest.g:594:9: (~ ( LineTerminator ) )*
	...
	private void mIdentifierStartASCII()
	{
		...
		try
		{
			// ES3YUITest.g:695:2: ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | BSLASH 'u' HexDigit HexDigit HexDigit HexDigit )
			int alt6=5;
			...
			case 5:
				DebugEnterAlt(5);
				// ES3YUITest.g:698:4: BSLASH 'u' HexDigit HexDigit HexDigit HexDigit
				{
				DebugLocation(698, 4);
				mBSLASH(); 
	...
	private void mIdentifierPart()
	{
		...
		try
		{
			// ES3YUITest.g:706:2: ( DecimalDigit | IdentifierStartASCII |{...}?)
			int alt7=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:706:4: DecimalDigit
				{
				DebugLocation(706, 4);
				mDecimalDigit(); 
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:707:4: IdentifierStartASCII
				{
				DebugLocation(707, 4);
	...
	private void mIdentifierNameASCIIStart()
	{
		...
		try
		{
			// ES3YUITest.g:712:2: ( IdentifierStartASCII ( IdentifierPart )* )
			DebugEnterAlt(1);
			// ES3YUITest.g:712:4: IdentifierStartASCII ( IdentifierPart )*
			{
			DebugLocation(712, 4);
			mIdentifierStartASCII(); 
			DebugLocation(712, 25);
			// ES3YUITest.g:712:25: ( IdentifierPart )*
	...
	private void mIdentifier()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:724:2: ( IdentifierNameASCIIStart |)
			int alt9=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:724:4: IdentifierNameASCIIStart
				{
				DebugLocation(724, 4);
	...
	private void mHexDigit()
	{
		...
		try
		{
			// ES3YUITest.g:812:2: ( DecimalDigit | 'a' .. 'f' | 'A' .. 'F' )
			DebugEnterAlt(1);
			// ES3YUITest.g:
			{
			DebugLocation(812, 2);
	...
	private void mExponentPart()
	{
		...
		try
		{
			// ES3YUITest.g:820:2: ( ( 'e' | 'E' ) ( '+' | '-' )? ( DecimalDigit )+ )
			DebugEnterAlt(1);
			// ES3YUITest.g:820:4: ( 'e' | 'E' ) ( '+' | '-' )? ( DecimalDigit )+
			{
			DebugLocation(820, 4);
			...
			DebugLocation(820, 33);
			// ES3YUITest.g:820:33: ( DecimalDigit )+
			int cnt11=0;
	...
	private void mDecimalIntegerLiteral()
	{
		...
		try
		{
			// ES3YUITest.g:824:2: ( '0' | '1' .. '9' ( DecimalDigit )* )
			int alt13=2;
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:825:4: '1' .. '9' ( DecimalDigit )*
				{
				DebugLocation(825, 7);
				MatchRange('1','9'); 
				DebugLocation(825, 13);
				// ES3YUITest.g:825:13: ( DecimalDigit )*
	...
	private void mDecimalLiteral()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:829:2: ( DecimalIntegerLiteral '.' ( DecimalDigit )* ( ExponentPart )? | '.' ( DecimalDigit )+ ( ExponentPart )? | DecimalIntegerLiteral ( ExponentPart )? )
			int alt19=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:829:4: DecimalIntegerLiteral '.' ( DecimalDigit )* ( ExponentPart )?
				{
				DebugLocation(829, 4);
				mDecimalIntegerLiteral(); 
				DebugLocation(829, 26);
				Match('.'); 
				DebugLocation(829, 30);
				// ES3YUITest.g:829:30: ( DecimalDigit )*
				...
				DebugLocation(829, 44);
				// ES3YUITest.g:829:44: ( ExponentPart )?
				int alt15=2;
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:830:4: '.' ( DecimalDigit )+ ( ExponentPart )?
				{
				DebugLocation(830, 4);
				Match('.'); 
				DebugLocation(830, 8);
				// ES3YUITest.g:830:8: ( DecimalDigit )+
				int cnt16=0;
				...
				DebugLocation(830, 22);
				// ES3YUITest.g:830:22: ( ExponentPart )?
				int alt17=2;
			...
			case 3:
				DebugEnterAlt(3);
				// ES3YUITest.g:831:4: DecimalIntegerLiteral ( ExponentPart )?
				{
				DebugLocation(831, 4);
				mDecimalIntegerLiteral(); 
				DebugLocation(831, 26);
				// ES3YUITest.g:831:26: ( ExponentPart )?
				int alt18=2;
	...
	private void mOctalIntegerLiteral()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:835:2: ( '0' ( OctalDigit )+ )
			DebugEnterAlt(1);
			// ES3YUITest.g:835:4: '0' ( OctalDigit )+
			{
			DebugLocation(835, 4);
			Match('0'); 
			DebugLocation(835, 8);
			// ES3YUITest.g:835:8: ( OctalDigit )+
			int cnt20=0;
	...
	private void mHexIntegerLiteral()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:839:2: ( ( '0x' | '0X' ) ( HexDigit )+ )
			DebugEnterAlt(1);
			// ES3YUITest.g:839:4: ( '0x' | '0X' ) ( HexDigit )+
			{
			DebugLocation(839, 4);
			// ES3YUITest.g:839:4: ( '0x' | '0X' )
			int alt21=2;
	...
	private void mCharacterEscapeSequence()
	{
		...
		try
		{
			// ES3YUITest.g:858:2: (~ ( DecimalDigit | 'x' | 'u' | LineTerminator ) )
			DebugEnterAlt(1);
			// ES3YUITest.g:
			{
			DebugLocation(858, 2);
	...
	private void mOctalEscapeSequence()
	{
		...
		try
		{
			// ES3YUITest.g:866:2: ( OctalDigit | ZeroToThree OctalDigit | '4' .. '7' OctalDigit | ZeroToThree OctalDigit OctalDigit )
			int alt23=4;
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:867:4: ZeroToThree OctalDigit
				{
				DebugLocation(867, 4);
				mZeroToThree(); 
			...
			case 3:
				DebugEnterAlt(3);
				// ES3YUITest.g:868:4: '4' .. '7' OctalDigit
				{
				DebugLocation(868, 7);
				MatchRange('4','7'); 
			...
			case 4:
				DebugEnterAlt(4);
				// ES3YUITest.g:869:4: ZeroToThree OctalDigit OctalDigit
				{
				DebugLocation(869, 4);
				mZeroToThree(); 
	...
	private void mHexEscapeSequence()
	{
		...
		try
		{
			// ES3YUITest.g:873:2: ( 'x' HexDigit HexDigit )
			DebugEnterAlt(1);
			// ES3YUITest.g:873:4: 'x' HexDigit HexDigit
			{
			DebugLocation(873, 4);
			Match('x'); 
			DebugLocation(873, 8);
			mHexDigit(); 
			DebugLocation(873, 17);
			mHexDigit(); 
	...
	private void mUnicodeEscapeSequence()
	{
		...
		try
		{
			// ES3YUITest.g:877:2: ( 'u' HexDigit HexDigit HexDigit HexDigit )
			DebugEnterAlt(1);
			// ES3YUITest.g:877:4: 'u' HexDigit HexDigit HexDigit HexDigit
			{
			DebugLocation(877, 4);
			Match('u'); 
			DebugLocation(877, 8);
			mHexDigit(); 
			DebugLocation(877, 17);
			mHexDigit(); 
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// ES3YUITest.g:881:2: ( BSLASH ( CharacterEscapeSequence | OctalEscapeSequence | HexEscapeSequence | UnicodeEscapeSequence ) )
			DebugEnterAlt(1);
			...
			mBSLASH(); 
			DebugLocation(883, 2);
			// ES3YUITest.g:883:2: ( CharacterEscapeSequence | OctalEscapeSequence | HexEscapeSequence | UnicodeEscapeSequence )
			int alt24=4;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:884:3: CharacterEscapeSequence
				{
				DebugLocation(884, 3);
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:885:5: OctalEscapeSequence
				{
				DebugLocation(885, 5);
			...
			case 3:
				DebugEnterAlt(3);
				// ES3YUITest.g:886:5: HexEscapeSequence
				{
				DebugLocation(886, 5);
				mHexEscapeSequence(); 
			...
			case 4:
				DebugEnterAlt(4);
				// ES3YUITest.g:887:5: UnicodeEscapeSequence
				{
				DebugLocation(887, 5);
	...
	private void mStringLiteral()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:892:2: ( SQUOTE (~ ( SQUOTE | BSLASH | LineTerminator ) | EscapeSequence )* SQUOTE | DQUOTE (~ ( DQUOTE | BSLASH | LineTerminator ) | EscapeSequence )* DQUOTE )
			int alt27=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:892:4: SQUOTE (~ ( SQUOTE | BSLASH | LineTerminator ) | EscapeSequence )* SQUOTE
				{
				DebugLocation(892, 4);
				mSQUOTE(); 
				DebugLocation(892, 11);
				// ES3YUITest.g:892:11: (~ ( SQUOTE | BSLASH | LineTerminator ) | EscapeSequence )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// ES3YUITest.g:892:13: ~ ( SQUOTE | BSLASH | LineTerminator )
						{
					...
					case 2:
						DebugEnterAlt(2);
						// ES3YUITest.g:892:53: EscapeSequence
						{
						DebugLocation(892, 53);
						mEscapeSequence(); 
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:893:4: DQUOTE (~ ( DQUOTE | BSLASH | LineTerminator ) | EscapeSequence )* DQUOTE
				{
				DebugLocation(893, 4);
				mDQUOTE(); 
				DebugLocation(893, 11);
				// ES3YUITest.g:893:11: (~ ( DQUOTE | BSLASH | LineTerminator ) | EscapeSequence )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// ES3YUITest.g:893:13: ~ ( DQUOTE | BSLASH | LineTerminator )
						{
	...
	private void mBackslashSequence()
	{
		...
		try
		{
			// ES3YUITest.g:901:2: ( BSLASH ~ ( LineTerminator ) )
			DebugEnterAlt(1);
			// ES3YUITest.g:901:4: BSLASH ~ ( LineTerminator )
			{
			DebugLocation(901, 4);
			mBSLASH(); 
	...
	private void mRegularExpressionFirstChar()
	{
		...
		try
		{
			// ES3YUITest.g:905:2: (~ ( LineTerminator | MUL | BSLASH | DIV ) | BackslashSequence )
			int alt28=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:905:4: ~ ( LineTerminator | MUL | BSLASH | DIV )
				{
				DebugLocation(905, 4);
				input.Consume();
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:906:4: BackslashSequence
				{
				DebugLocation(906, 4);
				mBackslashSequence(); 
	...
	private void mRegularExpressionChar()
	{
		...
		try
		{
			// ES3YUITest.g:910:2: (~ ( LineTerminator | BSLASH | DIV ) | BackslashSequence )
			int alt29=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ES3YUITest.g:910:4: ~ ( LineTerminator | BSLASH | DIV )
				{
				DebugLocation(910, 4);
				input.Consume();
			...
			case 2:
				DebugEnterAlt(2);
				// ES3YUITest.g:911:4: BackslashSequence
				{
				DebugLocation(911, 4);
				mBackslashSequence(); 
	...
	private void mRegularExpressionLiteral()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ES3YUITest.g:915:2: ({...}? => DIV RegularExpressionFirstChar ( RegularExpressionChar )* DIV ( IdentifierPart )* )
			DebugEnterAlt(1);
			// ES3YUITest.g:915:4: {...}? => DIV RegularExpressionFirstChar ( RegularExpressionChar )* DIV ( IdentifierPart )*
			{
			DebugLocation(915, 4);
			...
			DebugLocation(915, 42);
			mDIV(); 
			DebugLocation(915, 46);
			mRegularExpressionFirstChar(); 
			DebugLocation(915, 73);
			// ES3YUITest.g:915:73: ( RegularExpressionChar )*
			...
			DebugLocation(915, 96);
			mDIV(); 
			DebugLocation(915, 100);
			// ES3YUITest.g:915:100: ( IdentifierPart )*
	...
	public override void mTokens()
	{
		...
		case 93:
			DebugEnterAlt(93);
			// ES3YUITest.g:1:554: SYNCHRONIZED
			{
			DebugLocation(1, 554);
			mSYNCHRONIZED(); 
	...
	private class DFA19 : DFA
	{
		...
		public override string Description { get { return "828:1: DecimalLiteral : ( DecimalIntegerLiteral '.' ( DecimalDigit )* ( ExponentPart )? | '.' ( DecimalDigit )+ ( ExponentPart )? | DecimalIntegerLiteral ( ExponentPart )? );"; } }
	...
	private int SpecialStateTransition32(DFA dfa, int s, IIntStream _input)
	{
		...
		case 0:
			{
				...
				else if (((LA32_1>='\u0000' && LA32_1<='\t')||(LA32_1>='\u000B' && LA32_1<='\f')||(LA32_1>='\u000E' && LA32_1<=')')||(LA32_1>='+' && LA32_1<='.')||(LA32_1>='0' && LA32_1<='<')||(LA32_1>='>' && LA32_1<='\u2027')||(LA32_1>='\u202A' && LA32_1<='\uFFFF')) && (( AreRegularExpressionsEnabled() ))) {s = 72;}
		...
		case 1:
			{
				input.Rewind();
				if (((LA32_1>='\u0000' && LA32_1<='\t')||(LA32_1>='\u000B' && LA32_1<='\f')||(LA32_1>='\u000E' && LA32_1<='\u2027')||(LA32_1>='\u202A' && LA32_1<='\uFFFF')) && (( AreRegularExpressionsEnabled() ))) {s = 72;}
